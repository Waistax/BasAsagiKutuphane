...
public class Dizey4 {
	...
	public Dizey4(Dizey4 ö) {
		yaz(ö);
	}
	
	/** Verilen dizeyi buna yazar.
	 * Bu dizeyi döndürür. */
	public Dizey4 yaz(Dizey4 ö) {
		System.arraycopy(ö.e, 0, e, 0, 16);
		return this;
	}
	
	/** Verilen dizeyleri çarpıp buna yazar.
	 * Bu dizeyi döndürür. */
	public Dizey4 çarp(Dizey4 sol, Dizey4 sağ) {
	...
	/** Verilen dizeyi bu dizeyle çarpar.
	 * Bu dizeyi döndürür. */
	public Dizey4 çarp(Dizey4 ö) {
		synchronized (TAMPON) {
			return yaz(TAMPON.çarp(this, ö));
		}
	}
	...
	public Dizey4 izdüşümDizeyi(float genişlik, float yükseklik, float derinlik) {
		e[ 0] = 2.0F / genişlik;
		e[ 1] = 0.0F;
		e[ 2] = 0.0F;
		e[ 3] = 0.0F;
	...
	public Dizey4 dönüşümDizeyiYaz(float x, float y, float z, float a, float bx, float by) {
		a = Hesaplayıcı.radyan(a);
		float sin = Hesaplayıcı.sin(a);
		float cos = Hesaplayıcı.cos(a);
	...
	/** Dönüşüm dizeyini günceller.
	 * Dizeyin daha önceden de dönüşüm dizeyi olduğunu varsayar. */
	public Dizey4 dönüşümDizeyiniGüncelle(float x, float y, float z, float a, float bx, float by) {
		a = Hesaplayıcı.radyan(a);
		float sin = Hesaplayıcı.sin(a);
		float cos = Hesaplayıcı.cos(a);
