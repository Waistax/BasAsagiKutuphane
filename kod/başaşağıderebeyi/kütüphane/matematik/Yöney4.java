...
/** Dört boyutlu bir yöney. Bileşenler ondalıklı sayılar olarak
 * saklanır. */
public class Yöney4 {
	...
	public Yöney4(	final float x,
					final float y,
					final float z,
					final float w) {
		this.değiştir(x, y, z, w);
	}
	...
	public Yöney4 aradeğer(	final Yöney4 ö,
							final float uzaklık,
	...
	public Yöney4 böl(final Yöney4 sol, final float sağ) {
		return this.değiştir(	sol.x / sağ,
								sol.y / sağ,
								sol.z / sağ,
								sol.w / sağ);
	}
	...
	public Yöney4 değiştir(	final float x,
							final float y,
							final float z,
							final float w) {
	...
	public Yöney4 değiştir(final Yöney4 ö) {
		return this.değiştir(ö.x, ö.y, ö.z, ö.w);
	}
	...
	/** Verilen yöneyin doğrultusunu (birim yöneyini) buna yazar. Bu
	 * yöneyi döndürür. */
	...
	/** Bu yöneyin bileşenlerini ayrı ayrı sıkıştırır. Bu yöneyi
	 * döndürür. */
	 ...
	 * Bu yöneyi döndürür. */
	public Yöney4 sıkıştır(	final Yöney4 ö,
							final Yöney4 alt,
							final Yöney4 üst) {
