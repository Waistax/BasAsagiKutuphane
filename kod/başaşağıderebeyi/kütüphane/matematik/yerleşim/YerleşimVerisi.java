...
enum YerleşimVerisi {
	...
	static YerleşimVerisi yerleşimVerisiEdin(
	...
	YerleşimVerisi diğerBoyuttakiniEdin() {
	...
	YerleşimVerisi aynıBoyuttakiniEdin(
		final DikdörtgenVerisi dikdörtgenVerisi) {
		return yerleşimVerisiEdin(dikdörtgenVerisi, ordinal() < 4);
	}
	
	/** Yerleştirdiği verinin değerini döndürür. */
	float değeriEdin(final Dikdörtgen dikdörtgen) {
